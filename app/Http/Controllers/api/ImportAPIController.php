            ...
            if ($request->has('cars') && is_array($request->cars)) {
                ...
                foreach ($request->cars as $car) {
                    ...
                    import_cars::create([
                        ...
                        'booking_customer_id' => $car['booking_customer_id'] ?? null,
                        'booking_price' => $car['booking_price'] ?? null,
                        'booking_advance' => $car['booking_advance'] ?? null,
                        'booking_date' => $car['booking_date'] ?? null,
                        'booking_notes' => $car['booking_notes'] ?? null,
                    ]);
                }
            }
