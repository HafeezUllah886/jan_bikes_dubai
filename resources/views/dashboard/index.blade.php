                ...
                <div class="row row-cols-xxl-5 row-cols-md-3 row-cols-1 g-0">
                        ...
                        <div class="py-4 px-3">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="flex-grow-1 ms-3">
                                    <h2 class="mb-0 cfs-22"><span class="counter-value" data-target="{{ accountBalanceByType('Business') }}">0</span></h2>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="mt-3 mt-md-0 py-4 px-3">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="flex-grow-1 ms-3">
                                    <h2 class="mb-0 cfs-22"><span class="counter-value" data-target="{{ accountBalanceByType('Customer') }}">0</span></h2>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="mt-3 mt-md-0 py-4 px-3">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="flex-grow-1 ms-3">
                                    <h2 class="mb-0 cfs-22"><span class="counter-value" data-target="{{ accountBalanceByType('Vendor') }}">0</span></h2>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="mt-3 mt-lg-0 py-4 px-3">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="flex-grow-1 ms-3">
                                    <h2 class="mb-0 cfs-22"><span class="counter-value" data-target="{{ totalAdvanceBooked() }}">0</span></h2>
                                </div>
                            </div>
                        </div>
                    </div>
