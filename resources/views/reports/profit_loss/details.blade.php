                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-lg-3 col-6">
                                    ...
                                    <h5 class="fs-14 mb-0"><span
                                            id="total-products">{{ number_format($purchases->count()) }}</span></h5>
                                </div>
                                <div class="col-lg-3 col-6">
                            ...
                            <div class="table-responsive">
                                <table class="table table-borderless text-center table-nowrap align-middle mb-0">
                                    ...
                                    <tfoot>
                                        ...
                                        <tr>
                                            <th colspan="10" class="text-end p-1 m-0">Expenses (-)</th>
                                            <th class="text-end p-1 m-0">
                                                {{ number_format($expenses, 2) }}</th>
                                            <th></th>
                                        </tr>
                                        <tr>
                                            <th colspan="10" class="text-end p-1 m-0">Extra Profit (+)</th>
                                            <th class="text-end p-1 m-0">
                                                {{ number_format($extra_profits, 2) }}</th>
                                            <th></th>
                                        </tr>
                                        @php
                                            $netPrfit = $totalNetProfitLoss - $expenses + $extra_profits;
                                        @endphp
                                        <tr>
                                            <th colspan="10" class="text-end p-1 m-0">Net Profit/Loss</th>
                                            <th
                                                class="text-end p-1 m-0 {{ $netPrfit < 0 ? 'text-danger' : 'text-success' }}">
                                                {{ number_format($netPrfit, 2) }}</th>
                                            <th></th>
                                        </tr>
                                    </tfoot>
                                </table>
