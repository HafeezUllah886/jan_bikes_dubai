        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <h3>Extra Profits</h3>
                    <div>
                        <a href="{{ route('extraprofitCategories.index') }}" class="btn btn-info ">Categories</a>
                        ...
                        <tbody>
                            @foreach ($profits as $key => $tran)
                                <tr>
                                    ...
                                    <td>
                                        @can('Extra Profit Delete')
                                            <a href="{{ route('extra_profit.delete', $tran->refID) }}"
