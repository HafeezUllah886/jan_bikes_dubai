...
@section('content')
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                ...
                                                @if ($purchase->status == 'Available')
                                                    <li>
                                                        <a class="dropdown-item" href="javascript:void(0);"
                                                            ...
                                                            data-bs-target="#bookModal{{ $purchase->id }}">
                                                ...
                                                @if ($purchase->status == 'Booked')
                                                    <li>
                                                        <a class="dropdown-item" href="javascript:void(0);"
                                                            data-bs-toggle="modal"
                                                            data-bs-target="#sellBookedModal{{ $purchase->id }}">
                                                            <i
                                                                class="ri-shopping-cart-fill align-bottom me-2 text-muted"></i>
                                                            Sell Booked Item
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a class="dropdown-item" href="javascript:void(0);"
                                                            data-bs-toggle="modal"
                                                            data-bs-target="#viewBookingModal{{ $purchase->id }}">
    ...
    <div class="modal fade zoomIn" id="addExpenses" tabindex="-1" aria-labelledby="addExpensesLabel"
        aria-hidden="true">
    ...
    @foreach ($purchases as $purchase)
        <!-- Book Modal -->
        <div class="modal fade" id="bookModal{{ $purchase->id }}" tabindex="-1"
            aria-labelledby="bookModalLabel{{ $purchase->id }}" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="bookModalLabel{{ $purchase->id }}">Book Purchase (Chassis:
                            {{ $purchase->chassis }})</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <form action="{{ route('purchase.book', $purchase->id) }}" method="POST">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" step="0.01" class="form-control" name="advance"
                                    value="0">
                            </div>
                            <div class="mb-3">
        ...
        @if ($purchase->status == 'Booked' && $purchase->booking)
            <div class="modal fade" id="viewBookingModal{{ $purchase->id }}" tabindex="-1"
                aria-labelledby="viewBookingModalLabel{{ $purchase->id }}" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="viewBookingModalLabel{{ $purchase->id }}">Booking Details
            ...
            <div class="modal fade" id="sellBookedModal{{ $purchase->id }}" tabindex="-1"
                aria-labelledby="sellBookedModalLabel{{ $purchase->id }}" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="sellBookedModalLabel{{ $purchase->id }}">Sell Booked Item
                                (Chassis: {{ $purchase->chassis }})</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                aria-label="Close"></button>
                        </div>
                            ...
                            <div class="modal-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control"
                                        value="{{ $purchase->booking->customer->title ?? 'N/A' }}" readonly>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Advance Amount Paid</label>
                                    <input type="text" class="form-control"
                                        value="{{ number_format($purchase->booking->advance ?? 0, 2) }}" readonly>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Booking Price</label>
                                    <input type="text" class="form-control"
                                        value="{{ number_format($purchase->booking->price ?? 0, 2) }}" readonly>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.01" class="form-control" name="vcc"
                                        value="0" required>
                                </div>
                                <div class="mb-3">
                                    <label for="date" class="form-label">Date</label>
